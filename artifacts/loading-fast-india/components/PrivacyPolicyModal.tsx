...
const sections: Section[] = [
  ...
  {
    icon: 'user-x',
    title: 'Age Limit — सिर्फ 18+ (अनिवार्य)',
    color: colors.red,
    items: [
      '🔴 Loading Fast India केवल 18 वर्ष या उससे अधिक आयु के व्यक्तियों के लिए है।',
      '⚠️ 18 से कम उम्र का कोई भी व्यक्ति App register या use नहीं कर सकता।',
      '📌 18 से कम उम्र का account मिलने पर — तुरंत account बंद + अभिभावक को सूचना।',
      '🔴 किसी नाबालिग के नाम पर जानबूझकर account बनाना — IPC 419 (Impersonation) के तहत FIR।',
      '✅ Register करने का मतलब है User स्वयं 18+ होने की पुष्टि करता है।',
    ],
  },
  {
    icon: 'slash',
    title: 'प्रतिबंधित माल नीति (Illegal Goods)',
    color: colors.red,
    items: [
      '🔴 Loading Fast India के platform पर किसी भी प्रकार का गैरकानूनी सामान transport करना पूर्णतः प्रतिबंधित है।',
      '🚫 प्रतिबंधित सामान: नशीला पदार्थ (Drugs), हथियार, विस्फोटक, नकली नोट, बिना permit की शराब, चोरी का माल।',
      '📌 ऐसा माल transport करते पकड़े जाने पर — LFI उस case में पूरी तरह अलग है और Driver/Vyapari स्वयं जिम्मेदार होंगे।',
      '🔴 LFI तुरंत उस Driver/Vyapari की जानकारी Police को देगा और खुद FIR दर्ज कराएगा।',
      '⚠️ NDPS Act, Arms Act और IPC 411 (चोरी का माल रखना) के तहत कड़ी कार्रवाई होगी।',
      '📌 Trip accept करना = Driver ने माल कानूनी होने की जिम्मेदारी ली — "मुझे नहीं पता था" मान्य नहीं।',
    ],
  },
  {
    icon: 'truck',
    title: 'वाहन Fitness, Insurance और Permit',
    color: colors.yellow,
    items: [
      '📌 Driver की गाड़ी का Insurance, Fitness Certificate और Permit — पूरी तरह Driver की खुद की जिम्मेदारी है।',
      '🔴 बिना valid insurance या permit के गाड़ी चलाना — Driver की गलती है, LFI की नहीं।',
      '⚠️ Motor Vehicles Act 1988 के तहत बिना fitness/permit गाड़ी चलाने पर Driver पर कार्रवाई होगी।',
      '📌 LFI vehicle documents की जांच का दायित्व नहीं लेता — यह Driver की जिम्मेदारी है।',
      '🔴 Expired documents से trip करना — Driver को LFI Platform से permanently बंद किया जाएगा।',
    ],
  },
  {
    icon: 'alert-circle',
    title: 'दुर्घटना और Road Incident नीति',
    color: colors.yellow,
    items: [
      '📌 Trip के दौरान कोई भी दुर्घटना (Accident), डकैती, या आपदा — Loading Fast India की जिम्मेदारी नहीं है।',
      '🔴 LFI एक digital platform है — transport operator नहीं। Trip का physical execution Driver और Vyapari का काम है।',
      '⚠️ Road accident में घायल व्यक्ति, माल का नुकसान, या वाहन क्षति — LFI कोई मुआवजा नहीं देगा।',
      '📌 Driver और Vyapari को खुद का और माल का बीमा करवाना चाहिए — LFI की यह जिम्मेदारी नहीं।',
      '✅ Emergency में: Police 100, Ambulance 108। LFI Admin को भी सूचित करें।',
    ],
  },
  {
    icon: 'edit',
    title: 'Privacy Policy Update नीति',
    color: colors.navy,
    items: [
      '📌 Loading Fast India कभी भी इस Privacy Policy को बिना पूर्व सूचना के update कर सकता है।',
      '✅ नई Policy OTA update के साथ App में automatically लागू हो जाएगी।',
      '🔴 App use करते रहना = नई Policy से पूरी तरह सहमत होना माना जाएगा।',
      '⚠️ "मुझे नई Policy की जानकारी नहीं थी" — यह कारण court या forum में मान्य नहीं होगा।',
      '📌 Policy की last updated date App में हमेशा दिखाई देती है।',
    ],
  },
  {
    icon: 'phone',
